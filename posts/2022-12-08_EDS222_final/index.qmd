...
As the results of the hypothesis test show, the average net shoreline movement in each region of California is not equal. Due to this, we can reject the null hypothesis that the average net shoreline movement will be equal in all the regions.
