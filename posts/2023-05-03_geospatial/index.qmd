...
description: We will use average annual sea surface temperature (SST) from the years 2008 to 2012 to characterize the average sea surface temperature within the region. The data we are working with was originally generated from [NOAA's 5km Daily Global Satellite Sea Surface Temperature Anomaly v3.1](https://coralreefwatch.noaa.gov/product/5km/index_5km_ssta.php).
...
date: 12-09-2022
citation: 
  url: https://kiranfavre.github.io/posts/2023-05-03_geospatial/ 
...
1. We need to begin by loading the necessary data listed above and validate the coordinate reference system.
...
I chose the Red Abalone, Haliotis rufescens.
